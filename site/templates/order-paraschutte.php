        ...
        <div style="padding-bottom:200px;" class="calculate-wrapper__one">
            ...
            <form onclick="getRadioGroupValue(this)" class="form-calculate">
                <div class="form-calculate__wrapper-one">
                    ...
                    <div id="calculate" class="raio-ul-one">
                        <div class="form_radio_btn">
                            <input id="radio" type="radio" name="radio1" value="90" checked>
                            <label for="radio">Static line<span style="font-weight: 400;font-size: 20px;line-height: 120%;color: #CAD1DC;">(самостоятельный прыжок)</span></label>
                            
                        </div>

                        <div class="form_radio_btn">
                            <input id="radio-2" type="radio" name="radio1" value="180">
                            <label for="radio-2">Тандем<span style="font-weight: 400;font-size: 20px;line-height: 120%;color: #CAD1DC;">(прыжок с инструктором)</span></label>
                            
                        </div>

                         <div class="form_radio_btn">
                            <input id="radio-3" type="radio" name="radio1" value="230">
                            <label for="radio-3">Тандем с видеосъемкой<span></span></label>
