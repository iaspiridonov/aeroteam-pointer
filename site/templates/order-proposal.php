...
<section class="section section-display">
    <div class="container container__calculate-go">
        ...
        <div class="calculate-wrapper__one">
            ...
            <form onclick="getRadioGroupValue(this)" class="form-calculate">
                <div class="form-calculate__wrapper-one">

                    <h1>Заказ сертификата на предложение руки и сердца</h1>

                    <div class="raio-ul-one">
                        <div class="form_radio_btn">
                            <input id="radio" type="radio" name="radio1" value="0" checked>
                            <label for="radio">Самолет PIPISTREL VIRUS</label>
                            
                        </div>

                        <div class="form_radio_btn">
                            <input id="radio-2" type="radio" name="radio1" value="0">
                            <label for="radio-2">Самолет SOKATA TB9</label>
                            
                        </div>

                        <div class="form_radio_btn">
                            <input id="radio-3" type="radio" name="radio1" value="0">
                            <label for="radio-3">Самолет STING TL2000</label>
                    ...
                    <div class="raio-ul-two">
                        ...
                        <div class="form_radio_btn-two">
                            ...
                            <label for="radio-4">15 мин.<br><span style="display: inline-block;margin-top: 20px;">900 леeв</sapn></label>
                        </div>

                        <div class="form_radio_btn-two">
                            <input id="radio-5" type="radio" name="radio2" value="1800">
                            <label for="radio-5">30 мин.<br><span style="display: inline-block;margin-top: 20px;">1800 леeв</sapn></label>
                        </div>
                    
                        <div class="form_radio_btn-two">
                            <input id="radio-6" type="radio" name="radio2" value="2700">
                            <label for="radio-6">45 мин.<br><span style="display: inline-block;margin-top: 20px;">2700 леев</sapn></label>
                        </div>
                        
                        <div class="form_radio_btn-two">
                            <input id="radio-7" type="radio" name="radio2" value="3600">
                            <label for="radio-7">60 мин.<br><span style="display: inline-block;margin-top: 20px;">3600 леев</sapn></label>
                        </div>
                    </div>
                ...
                <div class="form-calculate__wrapper-two">
                    ...
                    <div class="form-calculate__copiright">
                     ...
                     <div style="margin-top: 95px;" class="raio-ul-two-title">Длительность полета</div>

                    <div class="raio-ul-three">
                   

                        <div class="form_radio_btn-two">
                            <input id="radio-8" type="radio" name="radio3" value="2000" checked>
                            <label style="font-size: 15px;line-height: 24px;" for="radio-8">Видеосъемка,<br> монтаж организация<br><span>2000 леев</sapn></label>
                        </div>

                        <div class="form_radio_btn-two">
                            <input id="radio-9" type="radio" name="radio3" value="300">
                            <label style="font-size: 15px;line-height: 24px;" for="radio-9">Видеосъемка <br>из салона<br><span>300 леев</sapn></label>
                        </div>
                    
                        <div class="form_radio_btn-two">
                            <input id="radio-10" type="radio" name="radio3" value="1800">
                            <label style="font-size: 15px;line-height: 24px;" for="radio-10">Видеосъемка <br>с монтажем<br><span>1800 леев</sapn></label>
                        </div>
        ...
        <div class="row text-center text-sm-start call-form align-items-sm-center">
            <div class="col-md-8 col-sm-7 col-12 pb-4 pb-sm-0 mb-4 mb-sm-0 u-border-right-sm-white u-border-bottom-m-white pe-sm-4">
                <div class="call-form__title">
                    Итого: <em id="result">2900</em> леев
                </div>
